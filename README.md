...
| # | File | What it shows |
|---|------|----------------|
| 1 | `01-access-certification-review-list.png` | A real access certification review queue — contains actual instances of a segregation-of-duties conflict (Finance Analyst + Approver held by the same identity), a role/job mismatch, and access creep across multiple identities |
